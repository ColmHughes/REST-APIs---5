...
class Item(Resource): #Our new Item class inherits from Resource, we don't have to use jsonify because the Resource class does it.
    ...
    def find_by_name(cls, name):   
        ...
        result = cursor.execute(query, (name,)) #The result it returned in a list.
        row = result.fetchone()
        connection.close()
    ...
    def post(self, name):
        if self.find_by_name(name):  #Could also call it by Item.find_by_name(name) as it's a class method.
